...
import com.example.shop.data.utils.openGoogleMaps
import com.example.shop.presentation.common.viewmodel.MainViewModel
import com.example.shop.presentation.common.viewmodel.ShoppingCartViewModel
import kotlin.math.roundToInt

@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
fun PlacingOrderScreen(navController: NavController, viewModel: MainViewModel, productId: String) {
            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            "Оплата будет производиться наложенным платежом при получении на почте. ",
                            style = TextStyle(
                                fontSize = 16.sp,
                                fontWeight = FontWeight(600),
                                color = Color.White
                ...
                ElevatedButton(
                    onClick = {
                        ...
                        currentUser?.value?.orderHistory?.add(productId)
                        ...
                        shoppingCartViewModel.createOrderedProduct(productId, currentUser.value!!.uid)
                ...
                if (showRatingDialog.value) {
                    ...
                    AlertDialog(
                        ...
                        title = { Text(text = "Ваш заказ успешно оформлен!") },
                        text = { Text(text = "Вы можете отследить состояние товара на вкладке история покупок.") },
                        confirmButton = {
                            Button(onClick = {
