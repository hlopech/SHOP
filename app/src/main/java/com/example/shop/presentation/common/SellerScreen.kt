...
import com.example.shop.presentation.common.viewmodel.SellerScreenViewModel
...
fun SellerScreen(navController: NavController, viewModel: MainViewModel) {
    ...
    val sellerScreenViewModel: SellerScreenViewModel = hiltViewModel()
            ...
            LazyColumn(
                ...
                item {
                    Row(
                        ...
                        Column() {
                            Text(
                                text = "Продажи ${allSales.value}",
                                color = MaterialTheme.colorScheme.secondary
                            )
                            Row {
                                Text(
                                    text = "Отзывы ${allReviews.value}",
                                    color = MaterialTheme.colorScheme.secondary
                                )
